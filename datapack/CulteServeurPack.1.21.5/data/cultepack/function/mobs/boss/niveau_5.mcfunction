...
summon armor_stand ~ ~20 ~ {drop_chances:{head:0},Invisible:1b,DisabledSlots:1052688,Invulnerable:1b,NoAI:1b,NoGravity:1b,Tags:["boss_5_c"],equipment:{head:{id:carved_pumpkin,components:{custom_model_data:{strings:["boss_5_c"]}},count:1}}}