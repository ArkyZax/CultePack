...
summon minecraft:zombie ~ ~20 ~ {drop_chances:{head:0,chest:0,offhand:0,mainhand:0},CustomName:[{text:'Zombie Mutant',"color":"green"}],active_effects:[{id:"minecraft:slow_falling",duration:80,amplifier:1}],DeathLootTable:"cultepack:entities/zombie_mutant",Tags:["zombie_mutant"],CustomNameVisible:1b,Health:1000,attributes:[{id:"max_health",base:1000f},{id:"armor",base:10f},{id:"attack_damage",base:80f},{id:"attack_knockback",base:10f},{id:"movement_speed",base:0.4f}],equipment:{head:{id:carved_pumpkin,components:{custom_model_data:{strings:["zombie_mutant_tete"]}},count:1},mainhand:{id:carved_pumpkin,components:{custom_model_data:{strings:["zombie_mutant"]}},count:1},offhand:{id:carved_pumpkin,components:{custom_model_data:{strings:["zombie_mutant_2"]}},count:1}}}
